...
puts $rCoinaUERUrXb1aA7dJu8qRcmvPNiKS3d
puts $destAmount
puts $XRP
puts $fd9848c79a71898a78172a02ab702298
...
returnValue = `#{ripple_path} #{conf} account_info rCoinaUERUrXb1aA7dJu8qRcmvPNiKS3d #{ledgerCurrent}`
print returnValue
...
$AccountLine = "\"Account\": \"rCoinaUERUrXb1aA7dJu8qRcmvPNiKS3d\"429739"
...
$issuerLine = "\"issuer\": \"rCoinaUERUrXb1aA7dJu8qRcmvPNiKS3d\"429739"
...
$AccountLine = "\"Account\": \"rCoinaUERUrXb1aA7dJu8qRcmvPNiKS3d\","
$FeeLine = '"Fee": "150000",'
$SeqLine = "\"Sequence\": #{newSeq},"
lvlLine = "\"LastLedgerSequence\": #{theLLS},"
flagsLine = '"Flags": 1348714151,'
